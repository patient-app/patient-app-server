...
import ch.uzh.ifi.imrg.patientapp.coachapi.MeetingController;
...
public class MeetingControllerTest {
    ...
    void createMeeting_shouldReturnCreatedMeeting() throws Exception {
        ...
        mockMvc.perform(post("/patients/{patientId}/meetings", patientId)
    ...
    void listMeetings_shouldReturnAllMeetings() throws Exception {
        ...
        mockMvc.perform(get("/patients/{patientId}/meetings", patientId))
    ...
    void getMeeting_shouldReturnMeeting() throws Exception {
        ...
        mockMvc.perform(get("/patients/{patientId}/meetings/{meetingId}", patientId, meetingId))
                .andExpect(status().isOk())
    ...
    void updateMeeting_shouldReturnUpdatedMeeting() throws Exception {
        ...
        mockMvc.perform(put("/patients/{patientId}/meetings/{meetingId}", patientId, meetingId)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(dto)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value(meetingId))
    ...
    void deleteMeeting_shouldReturnNoContent() throws Exception {
        ...
        mockMvc.perform(delete("/patients/{patientId}/meetings/{meetingId}", patientId, meetingId))
